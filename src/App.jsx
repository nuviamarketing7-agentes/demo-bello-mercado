...
export default function App() {
  ...
  const handleChatSend = async () => {
    ...
    try {
      ...
      // Parse ACTIONS_JSON:[...] or fallback to plain JSON array, or extract individual objects
      let cleanContent = fullContent;
      let actions = [];

      try {
        // 1. Try to extract a full array first (the proper way)
        ...
        // 2. Fallback: if no valid array was found, extract individual JSON objects (handles comma-separated bare objects)
        if (!parsedArray) {
          ...
          if (matches) {
            ...
            // Clean up leftover syntax artifacts
      ...
      if (actions && actions.length > 0) {
        ...
        let currentCart = [...cart]; // Local synchronous cart tracking
          ...
          switch (act.action) {
            ...
            case 'add_to_cart': {
              ...
              if (product) {
                ...
                // Update local copy synchronously for immediate use in same tick
  ...
  return (
    <div className="app-container">
      ...
      <main className="main-content container fade-in">
        ...
        {(activeCategory === 'todo' || activeCategory === 'carniceria') && !searchQuery && (
      ...
      <footer className="footer">
        <div className="container footer-text">
          <p>© 2026 Bello Mercado — Rambla Costanera, Solymar, Ciudad de la Costa. Tel: 2681 3030</p>
        </div>
      </footer>
    </div>
  );
