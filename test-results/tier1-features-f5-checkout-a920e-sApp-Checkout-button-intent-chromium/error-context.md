...
- Name: tier1-features/f5-checkout-whatsapp.spec.js >> F5: Checkout via WhatsApp >> Checkout button intent
- Location: e2e/tier1-features/f5-checkout-whatsapp.spec.js:4:3
