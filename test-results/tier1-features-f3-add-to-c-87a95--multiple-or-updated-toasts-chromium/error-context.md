...
- Name: tier1-features/f3-add-to-cart-toast.spec.js >> F3: Add to Cart Toast >> Multiple adds show multiple or updated toasts
- Location: e2e/tier1-features/f3-add-to-cart-toast.spec.js:37:3
...
Locator:  locator('.toast, [role="alert"]')
Expected: not 0
Received: 0
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('.toast, [role="alert"]')
...
- generic [ref=e3]:
  ...
  - main [ref=e12]:
    ...
    - generic [ref=e34]:
      ...
      - button "+ Agregar Asado ($390/kg)" [active] [ref=e41] [cursor=pointer]
    - generic [ref=e42]:
  ...
  - generic [ref=e2197]:
    - generic [ref=e2198]:
      - generic [ref=e2199]:
        - generic [ref=e2200]: 🤖
        - generic [ref=e2201]:
          - strong [ref=e2202]: Asistente Bello Mercado
          - generic [ref=e2203]: ● ● En línea
      - button "Cerrar chat" [ref=e2204] [cursor=pointer]: ✕
    - generic [ref=e2206]:
      - paragraph [ref=e2207]:
        - text: ¡Hola! Soy el asistente virtual de
        - strong [ref=e2208]: Bello Mercado
        - text: 🥩
      - paragraph
      - paragraph [ref=e2209]:
        - text: Estoy aquí para ayudarte en todo lo que necesites. Puedo
        - strong [ref=e2210]: buscar productos
        - text: ","
        - strong [ref=e2211]: agregarlos directamente al carrito
        - text: por vos, o
        - strong [ref=e2212]: guiarte en la navegación
        - text: de la página (como abrir el carrito, ir al checkout y confirmar el pedido).
      - paragraph
      - paragraph [ref=e2213]:
        - text: ¿En qué puedo ayudarte hoy? ¡Probá decirme
        - emphasis [ref=e2214]: "\"Agregá 2kg de asado al carrito\""
        - text: o
        - emphasis [ref=e2215]: "\"Mostrame las bebidas\""
        - text: "!"
    - generic [ref=e2216]:
      - button "🔥 Ofertas" [ref=e2217] [cursor=pointer]
      - button "🥩 Asado" [ref=e2218] [cursor=pointer]
      - button "🛒 Finalizar compra" [ref=e2219] [cursor=pointer]
    - generic [ref=e2220]:
      - 'textbox "Ej: ¿Tienen asado? o Mostrame bebidas..." [ref=e2221]'
      - button "Enviar mensaje" [disabled] [ref=e2222]: ➤
  - button "Cerrar chat" [ref=e2223] [cursor=pointer]: ✕
