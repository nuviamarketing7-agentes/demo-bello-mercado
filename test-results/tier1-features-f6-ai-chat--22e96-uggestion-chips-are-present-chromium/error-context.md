...
- Name: tier1-features/f6-ai-chat.spec.js >> F6: AI Chat Interface >> Quick suggestion chips are present
- Location: e2e/tier1-features/f6-ai-chat.spec.js:33:3
...
Locator: locator('.chat-suggestion-chip').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.chat-suggestion-chip').first()
