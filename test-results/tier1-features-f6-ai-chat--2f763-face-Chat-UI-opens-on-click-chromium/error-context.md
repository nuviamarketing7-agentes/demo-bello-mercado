...
- Name: tier1-features/f6-ai-chat.spec.js >> F6: AI Chat Interface >> Chat UI opens on click
- Location: e2e/tier1-features/f6-ai-chat.spec.js:4:3
...
Call log:
  ...
  - waiting for locator('.chat-window')
