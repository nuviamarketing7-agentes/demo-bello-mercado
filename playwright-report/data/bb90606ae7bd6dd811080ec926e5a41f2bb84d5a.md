...
- Name: tier1-features/f4-cart-management.spec.js >> F4: Cart Management >> Minus button decreases count
- Location: e2e/tier1-features/f4-cart-management.spec.js:21:3
...
Call log:
  - waiting for getByRole('button', { name: '+' }).first()
    - locator resolved to <button>+ Agregar Asado ($390/kg)</button>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <div class="cart-items">…</div> from <div class="cart-overlay">…</div> subtree intercepts pointer events
  ...
  12 × retrying click action
       ...
       - scrolling into view if needed
       - done scrolling
       - <aside class="cart-sidebar">…</aside> from <div class="cart-overlay">…</div> subtree intercepts pointer events
     - retrying click action
       - waiting 500ms
       - waiting for element to be visible, enabled and stable
