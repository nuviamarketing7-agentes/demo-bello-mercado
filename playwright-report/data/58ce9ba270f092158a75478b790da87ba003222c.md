...
- Name: tier1-features/f1-product-grid.spec.js >> F1: Product Grid >> Initial load displays products
- Location: e2e/tier1-features/f1-product-grid.spec.js:4:3
...
Locator: locator('.product-grid, [data-testid="product-grid"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.product-grid, [data-testid="product-grid"]')
