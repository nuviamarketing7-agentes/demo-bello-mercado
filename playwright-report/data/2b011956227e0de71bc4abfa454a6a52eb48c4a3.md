...
- Name: tier1-features/f5-checkout-whatsapp.spec.js >> F5: Checkout via WhatsApp >> Empty cart disables checkout
- Location: e2e/tier1-features/f5-checkout-whatsapp.spec.js:62:3
...
Locator: getByRole('button', { name: /comprar/i })
Expected: disabled
Timeout: 5000ms
