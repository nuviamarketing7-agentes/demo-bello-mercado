...
- Name: tier1-features/f4-cart-management.spec.js >> F4: Cart Management >> Cart drawer displays items
- Location: e2e/tier1-features/f4-cart-management.spec.js:4:3
...
Locator:  locator('.cart-drawer .cart-item')
Expected: 1
Received: 0
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('.cart-drawer .cart-item')
