...
- Name: tier1-features/f4-cart-management.spec.js >> F4: Cart Management >> Zero quantity removes item
- Location: e2e/tier1-features/f4-cart-management.spec.js:31:3
...
Call log:
  - waiting for getByRole('button', { name: '-' }).first()
  ...
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      ...
      - done scrolling
      - <div class="cart-overlay">…</div> intercepts pointer events
...
- generic [ref=e3]:
  ...
  - button "Volver arriba" [ref=e2246] [cursor=pointer]: ↑
  - contentinfo [ref=e2247]:
    - generic [ref=e2248]:
      - generic [ref=e2249]:
        - heading "📍 Bello Mercado" [level=4] [ref=e2250]
        - paragraph [ref=e2251]:
          - text: Rambla Costanera
          - text: Solymar, Ciudad de la Costa
      - generic [ref=e2252]:
        - heading "📞 Contacto" [level=4] [ref=e2253]
        - paragraph [ref=e2254]:
          - text: "Tel: 2681 3030"
          - text: "WhatsApp: 093 635 208"
      - generic [ref=e2255]:
        - heading "⏰ Horarios" [level=4] [ref=e2256]
        - paragraph [ref=e2257]:
          - text: "Lunes a Sábados: 08:00 - 22:00"
          - text: "Domingos: 08:00 - 15:00"
    - paragraph [ref=e2259]: © 2026 Bello Mercado. Todos los derechos reservados.
```
